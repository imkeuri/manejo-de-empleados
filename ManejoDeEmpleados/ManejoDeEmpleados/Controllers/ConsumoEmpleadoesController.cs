...
namespace ManejoDeEmpleados.Controllers
{
    public class ConsumoEmpleadoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Cooperativa,Cafeteria,EmpleadoId")] ConsumoEmpleado consumoEmpleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cooperativa,Cafeteria,EmpleadoId")] ConsumoEmpleado consumoEmpleado)
        {
